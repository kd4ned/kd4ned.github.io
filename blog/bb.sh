...
global_variables() {
    ...
    # Blog title
    global_title="The Mind of Jeremy Gault"
    # The typical subtitle for each blog
    global_description="Thoughts, rants, raves, and whatever..."
    # The public base URL for this blog
    global_url="http://kd4ned.github.io/blog"

    # Your name
    global_author="The Ubik"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="http://twitter.com/TheUbik" 
    # Your email
    global_email="kd4ned@gmail.com"
